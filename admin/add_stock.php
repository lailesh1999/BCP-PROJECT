...
?>
        ...
        <br>
    				...
    				<input type="text" class="form-control" style="width:15%;" name="batch_number" required>
    				...
    				<input type="number" class="form-control" id=qty style="width:15%;" name="quantity" required>
                    <label>ENTER INDIVIDUAL PRICE:</label>
    				<input type="number" class="form-control" id="itotal" onkeyup="calTotal(this.value)" style="width:15%;" name="purchase_price" required>
    				...
    				<input type="number" class="form-control" style="width:15%;" name="invoice_number" required>
                    <label>TOTAL PRICE:</label>
    				<input type="number" id="total" class="form-control" style="width:15%;" name="total_price" required><BR>
