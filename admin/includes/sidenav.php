...
<!--
            <li class="nav-item">
              <a class="nav-link" href="add_tax.php">
                ...
                <span class="nav-link-text" style="color:red;">ADD TAX</span>
              </a>
            </li>
            <li class="nav-item">
        ...
        -->  
            <li class="nav-item">
              <a class="nav-link" href="add_units.php">
                ...
                <span class="nav-link-text"style="color:purple;">ADD UNITS</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_unit.php">
                <i class="fas fas fa-clipboard text-purple"></i>
                <span class="nav-link-text"style="color:purple;">VIEW  UNITS </span>
              </a>
            </li>
              <li class="nav-item">
              <a class="nav-link" href="add_category.php">
                <i class="fas fas fa-briefcase text-black"></i>
                <span class="nav-link-text"style="color:black;">ADD CATEGORY </span>
              </a>
            </li>
         </li>
            <li class="nav-item">
              <a class="nav-link" href="view_category.php">
                <i class="fas fas fa-briefcase text-black"></i>
                <span class="nav-link-text" style="color:black;">VIEW CATEGORY</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_supplier.php">
                <i class="fas fas fa-calendar text-indigo"></i>
                <span class="nav-link-text" style="color:indigo;">ADD SUPPLIER</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_supplier.php">
                <i class="fas fas fa-calendar text-indigo"></i>
                <span class="nav-link-text" style="color:indigo;">VIEW SUPPLIER</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_product.php">
                <i class="fas fa-capsules text-blue"></i>
                <span class="nav-link-text" style="color:navy;">ADD MEDICINE</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_product.php">
                <i class="fas fa-capsules text-blue"></i>
                <span class="nav-link-text" style="color:navy;">VIEW MEDICINE</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="add_stock.php">
                <i class="fas fa-laptop-medical text-maroon"></i>
                <span class="nav-link-text" style="color:black;">ADD STOCK</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_stock.php">
                <i class="fas fa-laptop-medical text-maroon"></i>
                <span class="nav-link-text" style="color:black;">VIEW STOCK</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="view_purchase.php">
                <i class="fas fa-notes-medical text-green"></i>
                <span class="nav-link-text" style="color:green;">VIEW PURCHASE</span>
              </a>
            </li>
            <li class="nav-item">
