...
(3, 'abc', '2022-10-15 05:12:15', '0', '1', '2117031', '1', '2117031'),
(4, 'aaa123', '2022-10-15 05:12:24', '0', '1', '2117031', '2117031', 'pending'),
(5, 'aaa', '2022-10-25 05:44:03', '0', '0', '2117031', 'pending', 'pending'),
(6, 'sss', '2022-11-11 04:15:20', '0', '1', '1', '1', 'pending'),
(7, 'syrub', '2022-11-12 15:25:38', '0', '1', '1', '1', 'pending'),
(8, 'syrub', '2022-11-12 15:25:38', '0', '1', '1', '1', 'pending'),
(9, 'aaa', '2022-11-12 15:29:05', '0', '1', '1', '1', 'pending'),
(10, 'aaaa', '2022-11-12 15:29:13', '0', '1', '1', '1', 'pending'),
(11, 'aaa', '2022-11-16 17:12:59', '0', '1', '1', '1', 'pending'),
(12, 'aa', '2023-01-01 17:50:29', '0', '1', '1', '1', 'pending'),
(13, 'dd', '2023-01-01 17:53:56', '0', '1', '1', '1', 'pending');
...
(1, 'lailesh veigasq', 'neyyamugaru house vorlady post via manjeshwar', 'lailesh07@gmail.com', '9074080165', 0, 0, '2022-11-27 05:22:41', '1', 'pending', '1'),
(2, 'roys', 'manglore,banglore', 'lailesh0744@gmail.com', '8547513364', 0, 0, '2023-01-01 18:01:54', '1', 'pending', '1'),
(3, 'lailesh veigas', 'aaaaa', 'lailesh07@gmail.com', '9074080165', 0, 0, '2023-02-12 11:50:40', '1', 'pending', 'pending'),
(4, 'royak', 'rrrr', 'lailesh07@gmail.com', '8847532265', 1, 0, '2023-02-12 11:54:13', '1', '1', 'pending'),
(5, 'hrithik', 'manglore', 'hrtthik@gmnaul.com', '8756432746', 0, 0, '2023-02-12 15:56:13', '1', 'pending', 'pending'),
(6, 'hrithik g', 'dddd', 'lailesh07@gmail.com', '9074080165', 1, 0, '2023-02-14 09:43:33', '1', '1', 'pending');
...
(53, 48, 0, 0, 2, 30, '2023-02-14 09:46:01'),
(54, 48, 18, 10, 1, 12, '2023-02-14 09:46:01'),
(55, 49, 0, 0, 2, 30, '2023-02-14 09:46:32'),
(56, 50, 20, 11, 1, 30, '2023-02-14 09:47:15'),
(57, 51, 0, 0, 3, 30, '2023-02-14 09:50:54'),
(58, 52, 18, 10, 3, 12, '2023-02-14 09:51:34'),
(59, 53, 18, 10, 6, 12, '2023-02-14 09:53:01'),
(60, 54, 18, 10, 6, 12, '2023-02-14 09:53:31'),
(61, 54, 20, 11, 3, 30, '2023-02-14 09:53:31'),
(62, 55, 20, 11, 4, 30, '2023-02-14 09:54:20'),
(63, 55, 18, 10, 4, 12, '2023-02-14 09:54:20'),
(64, 56, 18, 13, 1, 12, '2023-02-20 05:28:49'),
(65, 56, 20, 12, 2, 30, '2023-02-20 05:28:49');
...
(48, 1115115, 5, 72, 0, 0, 0, '2023-02-14 09:46:01'),
(49, 6152469, 0, 72, 0, 0, 0, '2023-02-14 09:46:32'),
(50, 6718506, 3, 30, 0, 0, 0, '2023-02-14 09:47:15'),
(51, 8101227, 3, 90, 0, 0, 0, '2023-02-14 09:50:54'),
(52, 2233582, 0, 36, 0, 0, 0, '2023-02-14 09:51:34'),
(53, 3490316, 3, 72, 0, 0, 0, '2023-02-14 09:53:01'),
(54, 7675909, 0, 162, 0, 0, 0, '2023-02-14 09:53:31'),
(55, 7797114, 3, 168, 0, 0, 0, '2023-02-14 09:54:20'),
(56, 1635152, 3, 72, 0, 0, 0, '2023-02-20 05:28:49');
...
(19, 2, 3, 1, 6, 'dolo', '12tabs', 'dolo', '2022-11-11 11:19:31', 0, 1, '1', '1', 'pending'),
(20, 2, 3, 1, 6, 'paracetamol ', '14tabs ', 'aaa', '2023-01-29 10:04:27', 0, 0, '1', 'pending', '1');
...
(13, 20, 3, 4, 30, 2117044, 120, 0, 0, '2023-02-20 05:26:43', '1', 'pending', 'pending', 0),
(14, 18, 4, 100, 12, 2117044, 1200, 0, 0, '2023-02-20 05:28:11', '1', 'pending', 'pending', 0);

-- --------------------------------------------------------

--
-- Table structure for table `return_stock_tbl`
--

CREATE TABLE `return_stock_tbl` (
  ...
  `status` int(5) NOT NULL DEFAULT '0',
  `deleted` int(5) NOT NULL DEFAULT '0',
  `inserted_by_id` varchar(15) NOT NULL DEFAULT 'pending',
  `deleted_by_id` varchar(15) NOT NULL DEFAULT 'pending',
  `updated_by_id` varchar(15) NOT NULL DEFAULT 'pending'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `return_stock_tbl`
--

INSERT INTO `return_stock_tbl` (`return_id`, `stock_id`, `supplier_id`, `product_id`, `quantity`, `batch_number`, `expiry_date`, `rate`, `created_date`, `status`, `deleted`, `inserted_by_id`, `deleted_by_id`, `updated_by_id`) VALUES
(15, 11, 3, 20, 300, 'C006', '2023-01-31', 30, '2023-02-19 12:17:40', 1, 0, '1', '1', 'pending'),
(16, 9, 4, 18, 3, 'c002', '2023-01-31', 33, '2023-02-19 13:28:23', 1, 0, '1', '1', 'pending'),
(17, 10, 4, 18, 65, 'c003', '2023-01-29', 12, '2023-02-19 13:28:27', 1, 0, '1', '1', 'pending');
...
CREATE TABLE `staff_tbl` (
  ...
  `created_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_by_id` int(3) NOT NULL DEFAULT '0',
  `inserted_by_id` int(3) NOT NULL DEFAULT '0',
  `updated_by_id` int(3) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `staff_tbl` (`staff_id`, `staff_name`, `staff_contact`, `staff_email`, `staff_address`, `password`, `status`, `deleted`, `created_date`, `deleted_by_id`, `inserted_by_id`, `updated_by_id`) VALUES
(7, 'aaa', '9074080165', 'lailesh@gmaul.com', 'ssss', '2222', 0, 1, '2023-02-16 17:25:14', 1, 1, 0),
(8, 'lailesh', '9074080161', 'lailesh@gmaul1.com', 'banglore', 'lailesh@1999', 0, 0, '2023-02-16 17:30:33', 0, 1, 1);
...
(8, 4, 0, 34, 'cold001', '2022-12-30', 13, 14, '2023-02-16 16:29:12', '0', 0, '1', '0', '1'),
(9, 4, 18, 3, 'c002', '2023-01-31', 34, 33, '2023-02-19 13:28:33', '1', 1, '1', '1', '1'),
(10, 4, 18, 65, 'c003', '2023-01-29', 14, 12, '2023-02-19 13:28:33', '1', 1, '1', '1', '0'),
(11, 3, 20, 300, 'C006', '2023-01-31', 35, 30, '2023-02-19 12:17:42', '1', 1, '1', '1', '1'),
(12, 3, 20, 2, 'c003', '2023-05-20', 30, 30, '2023-02-20 05:28:49', '0', 0, '1', '0', '0'),
(13, 4, 18, 99, 'c003', '2023-06-17', 12, 12, '2023-02-20 11:59:02', '0', 0, '1', '8', '0');
...
(4, 'sales tax', 20, '2022-10-15 12:07:19', '0', '1', '1', '1', '2117031'),
...
(8, 'sales', 45, '2022-11-12 11:10:51', '0', '1', '1', 'pending', '1'),
(9, 'GST', 1000000, '2022-11-12 11:20:36', '0', '1', '1', '1', '1'),
(10, 'sales', 0, '2022-11-12 11:53:57', '0', '1', '1', 'pending', '1'),
(11, 'Hello', 2117032, '2022-11-16 17:28:26', '0', '1', '1', 'pending', '1'),
(12, 'NO TAX', 0, '2022-11-28 08:20:34', '0', '1', '1', 'pending', '1'),
(13, 'GST', 34, '2023-02-16 14:11:24', '0', '1', '1', 'pending', '1'),
(14, 'sales', 0, '2023-02-16 14:24:17', '0', '1', '1', 'pending', '1');
...
(3, 'litre', '2022-10-14 15:12:00', '0', '1', '2117031', '1', '2117031'),
(4, 'gram', '2022-11-12 14:53:37', '0', '1', '1', '1', 'pending'),
(5, 'gram', '2022-11-12 14:53:54', '0', '1', '1', '1', 'pending'),
(6, 'dd', '2023-01-22 10:21:34', '0', '1', '1', '1', 'pending'),
(7, 'aa', '2023-02-11 13:39:12', '0', '1', '1', '1', 'pending');
...
--
-- Indexes for table `return_stock_tbl`
--
ALTER TABLE `return_stock_tbl`
...
--
ALTER TABLE `invoice_detail_tbl`
  MODIFY `invoice_detail_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
...
--
ALTER TABLE `purchase_tbl`
  MODIFY `purchase_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `return_stock_tbl`
--
ALTER TABLE `return_stock_tbl`
  MODIFY `return_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `staff_tbl`
--
ALTER TABLE `staff_tbl`
  MODIFY `staff_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tax_tbl`
  MODIFY `tax_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
