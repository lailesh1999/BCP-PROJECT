...
<tr><td style="text-align: center;"> <?php echo " $product_name"; ?></td>
        ...
        <?php
        $q = "update stock_tbl set deleted = '1',deleted_by_id = '$staff_id' where stock_id = '$stock_id'";
        $r = $link->query($q);
        $q1 = "update return_stock_tbl set status = '1',deleted_by_id = '$staff_id' where return_id = '$return_id'";
        $r1 = $link->query($q1);
 }
?>
                </tr>
