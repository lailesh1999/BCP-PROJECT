...
if(isset($_POST['addstock']))
{
    ...
    $total_price = $_POST['total_price'];
	  ...
	  echo $query= " insert into stock_tbl (supplier_id,product_id,batch_number,quantity,expiry_date,mrp,rate,inserted_by_id) values ('$supplier_id','$product_id','$batch_number','$quantity','$expiry_date','$mrp','$price','$staff_id')";
