...
$query = "select p.product_name,pt.quantity,pt.purchase_price,pt.invoice_number,pt.total_price,s.supplier_name,p.product_id,pt.purchase_id,pt.created_date,s.supplier_id from product_tbl p,purchase_tbl pt,supplier_tbl s where s.supplier_id = pt.supplier_id and p.product_id=.pt.product_id and s.supplier_id=pt.supplier_id and p.deleted='0' and pt.deleted='0' and s.deleted='0'";
